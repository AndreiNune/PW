    ...
    <div class="nav">
        <ul class="nav_links">
            <div class="links-item">
                ...
                <il class="nav_links li"><button><a href="Autorpesquisar.php">Pesquisar</a></button></il>
                <il class="nav_links li"><button><a href="Alterars/Altres.php">Alterar</a></button></il>
            </div>
        </ul>
    </div>
